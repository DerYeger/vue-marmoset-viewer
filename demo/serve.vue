...
<template>
  <div id="app">
    <header>
      ...
      <a href="https://github.com/DerYeger/vue-marmoset-viewer/" target="_blank" rel="noopener" aria-label="GitHub Repository">
        <svg
          width="38px"
          height="38px"
          viewBox="0 0 256 250"
      ...
      <p class="subtitle" style="margin-top: 0.5rem">
        ...
        <a href="https://marmoset.co/toolbag/viewer/" target="_blank" rel="noopener">Marmoset Viewer</a> component for Vue.
      </p>
      <div class="row">
        <a href="https://github.com/DerYeger/vue-marmoset-viewer/actions/workflows/ci.yml" target="_blank" rel="noopener">
          <img
            alt="CI"
            src="https://img.shields.io/github/workflow/status/DerYeger/vue-marmoset-viewer/CI?label=ci&logo=github&color=#4DC71F"
          />
        </a>
        ...
        <a href="https://codecov.io/gh/DerYeger/vue-marmoset-viewer" target="_blank" rel="noopener">
          <img alt="Coverage" src="https://codecov.io/gh/DerYeger/vue-marmoset-viewer/branch/master/graph/badge.svg?token=p35W6u2noe" />
        </a>
        <a href="https://lgtm.com/projects/g/DerYeger/vue-marmoset-viewer" target="_blank" rel="noopener">
        ...
        <a href="https://bundlephobia.com/package/vue-marmoset-viewer" target="_blank" rel="noopener">
    ...
    <main>
      <div class="row">
        <label>Model</label>
        <button v-for="file of files" :key="file" @click="src = file" :disabled="src === file">{{ file | capitalize }}</button>
      </div>
      <div>
      ...
      <div style="flex: 1">
        <marmoset-viewer :src="`${src}.mview`" :auto-start="autoStart" :responsive="responsive" :width="+width" :height="+height" />
      </div>
    </main>
    <footer>
